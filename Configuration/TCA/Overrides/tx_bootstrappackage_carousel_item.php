    ...
    'types' => [
        ...
        'text_and_image' => [
            'showitem' => '
                ...
                // add background_media field to image_text ytyle of carousel item
                background_media,
...
//                        'tt_content',
        ...
        'background_image' => [
            ...
            'label' => 'background_image overwritten in videoprocessing',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                'background_image',
                [
                    'appearance' => [
        ...
        'background_media' => [
            ...
            // there are no frames in carousel items?!
            ...
            'label' => '[background_media for carousel item in videoprocessing]',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
            // 'background_image',
                'background_media',
                // 'media',
        ...
        'content_elements' => [
            ...
            'config' => [
                ...
                // ToDo: check database field again

                'foreign_field' => 'tx_blogexample_content_elements',
                'minitems' => 0,
                'maxitems' => 99,
                'appearance' => [
                    'collapseAll' => 1,
